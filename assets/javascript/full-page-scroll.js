		...
		this.mouseWheelAndKey = function (event) {
			...
			if (event.deltaY > 0 || event.keyCode == 40) {	
				...
				if (slideDeckImages.length > 0) {
					slideDeckImages.forEach(function(element) {
						element.style.height = '100vh';
					});
				}
				//reset last scroll up 
				lastScrollUp = false;
